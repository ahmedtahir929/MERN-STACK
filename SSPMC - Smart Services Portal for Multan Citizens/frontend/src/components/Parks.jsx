...
const Parks = ({ items, onEdit }) => {
  ...
  if (!items || items.length === 0) {
    return <EmptyServicesState categoryName="Parks" />;
  }
  ...
  return (
    <div className="w-full space-y-4">
      {items.map((item) => {
        ...
        const locationText =
          item.location?.address || item.loc || 'Address not registered';
        ...
        return (
          ...
          >
            ...
            <div className="grow w-full">
              ...
              <p
                className="text-md mt-1 wrap-break-words opacity-80"
